...
export default function ProfileSideBar({ handleLogout }) {
    ...
    const handlesShowchatbot = () => setShowChatbot(true);
    ...
    return (
        ...
        >
            ...
            <IconButton className="bi bi-search" text="Explore" /><IconButton className="bi bi-bell" text="Notifications" /><IconButton className="bi bi-envelope" text="Messages" /><IconButton className="bi bi-journal-text" text="Lists" /><IconButton className="bi bi-bookmark" text="Bookmarks" /><IconButton className="bi bi-patch-check" text="Verified" /><IconButton className="bi bi-person" text="Profile" /><IconButton className="bi bi-chat-square-text" text="Chatbot" onClick={handlesShowchatbot} />
            <IconButton
