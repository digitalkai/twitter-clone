...
export default function AuthPage() {
    ...
    const url =
        "https://45736841-8981-4f30-9fc5-c6d832283cc2-00-qzgmhh540ct3.kirk.repl.co"
            ...
            <Col sm={6} className="p-4">
                ...
                <Modal show={modalShow !== null}
                    ...
                    <Modal.Body>
                        ...
                        <Form className="d-grid gap-2 px-5" onSubmit={modalShow === "SignUp" ? handleSingUp : handleLogin}>
